...
network = CPCCharacterClassifierLightningV4(src_checkpoint_path=src_ckpt, batch_size=params['batch_size'], LSTM=True, LSTMLayers=2)

trainer = pl.Trainer(gpus=1, callbacks=[EarlyStopping(monitor='train_loss', patience=10)], default_root_dir="two_layer_lstm")
